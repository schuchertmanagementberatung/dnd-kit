...
export interface Arguments
  extends Omit<UseDraggableArguments, 'disabled' | 'id' | 'type'>,
...
export function useSortablePreview({
  ...
  //   collisions,
  // } = useDndContext();
  // console.log('preview', collisions);
  ...
  const placeholderIsActive = items.includes(id);
